<template>
    <div>
        ...
        <div class="formContainer" id="orderForm">
            ...
            <p>Your bill : {{bill}} TK</p>
            <form class="orderForm" @submit.prevent="orderForm">
            <ul>
                <li>
                <input
                    type="text"
        ...
        methods : {
            ...
            orderForm(){
                if(this.verifyData()){
                    ...
                    this.grettings(this.user.name,this.user.phone,this.user.address)
                }
            ...
            grettings(name,phone,address){
                alert('Thanks ' + name + '\nYour Bill : ' + this.bill+ ' TK\nYour Number : ' + phone + '\n' + 'Your Address is : ' + address);
            }
        },
        watch : {
            'user.phone' (old){
